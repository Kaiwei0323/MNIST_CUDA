...
int main()
{
    ...
    cudnnFindConvolutionForwardAlgorithm(cudnn, input_desc, filter_desc, conv_desc, output_desc, CUDNN_CONVOLUTION_FWD_ALGO_FFT, 0, &falgo_perf);
    cudnnConvolutionFwdAlgo_t falgo = falgo_perf.algo;
    ...
    cudnnFindConvolutionBackwardFilterAlgorithm(cudnn, input_desc, output_desc, conv_desc, filter_desc, CUDNN_CONVOLUTION_BWD_FILTER_ALGO_FFT, 0, &b_falgo_perf);
    cudnnConvolutionBwdFilterAlgo_t b_falgo = b_falgo_perf.algo;
    ...
    cudnnFindConvolutionBackwardDataAlgorithm(cudnn, filter_desc, output_desc, conv_desc, input_desc, CUDNN_CONVOLUTION_BWD_DATA_ALGO_FFT, 0, &b_dalgo_perf);
    cudnnConvolutionBwdDataAlgo_t b_dalgo = b_dalgo_perf.algo;
